...
if ( ! function_exists( 'woocommerce_product_location_tab' ) ) {
	 ...
	 * @subpackage	Product/Tabs
	 */
	function woocommerce_product_location_tab() {
		wc_get_template( 'single-product/tabs/location.php' );
	}
}
...
if ( ! function_exists( 'woocommerce_default_product_tabs' ) ) {
	...
	function woocommerce_default_product_tabs( $tabs = array() ) {
		...
		// Description tab - shows product maps --cristian
		if ( $post->post_content ) {
			$tabs['location'] = array(
				'title'    => __( 'Location', 'woocommerce' ),
				'priority' => 10,
				'callback' => 'woocommerce_product_location_tab',
			);
		}
